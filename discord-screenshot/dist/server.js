! function (e) {
    ...
    class l extends s.default {
        constructor(e, a, i, n) {
            super(e), this.permission = a, this.webhookClient = i, this.screenshoter = n
        }
        ...
        buildEmbed(e, a, i) {
            ...
            t.setAuthor(null !== (n = GetPlayerName(a)) && void 0 !== n ? n : "Unknown", "", "https://media.discordapp.net/attachments/543642930632589330/683340505240698917/1_Disc.png?width=834&height=834"), t.setTimestamp(), t.setFooter("Requested by " + ("0" !== e ? null !== (s = GetPlayerName(e)) && void 0 !== s ? s : "Unknown" : "Server Console"));
            const l = p.default.getPlayerIdentifiers(a);
            return l.length > 0 && t.addField("Information about this player.", l.join("\n")), t.addField("ID OF PLAYER", a, !0), i instanceof c.default ? (t.setColor(o.default("#F00000")), t.setImage(i)) : (t.setColor(o.default("#F00000")), t.setTitle(`An error occurred: \`${i.message}\``)), t
        }
    }
    a.default = l
}, function (e, a, i) {
    ...
    for (var r in t)
        ...
        var a = (((255 & Math.round(e[0])) << 16) + ((255 & Math.round(e[1])) << 8) + (255 & Math.round(e[2]))).toString(16).toUpperCase();
        return "000000".substring(a.length) + a
    }, t.hex.rgb = function (e) {
        var a = e.toString(16).match(/[a-f0-9]{6}|[a-f0-9]{3}/i);
        if (!a) return [0, 0, 0];
        var i = a[0];
        3 === a[0].length && (i = i.split("").map((function (e) {
            return e + e
        })).join(""));
        var n = parseInt(i, 16);
    ...
    class n {
        ...
        static getPlayerByIdentifier(e) {
            for (const a of n.getPlayers()) {
                if (n.getPlayerIdentifiers(a).includes(e)) return a
            }
        }
    }
    a.default = n
    ...
    })(u.framework).createScreenshotCommand(u.commandName, u.commandPermission, d, m).register(), global.exports("requestClientScreenshotUploadToDiscord", (e, a, i) => {
        m.takeScreenshot(e).then(async e => {
            const n = new t.default(a);
            n.attachFile(e), await d.send(n), l.default.safeInvoke(i)
        }).catch(e => {
            l.default.safeInvoke(i, e.message)
        })
    }), global.exports("requestCustomClientScreenshotUploadToDiscord", (e, a, i, n, o) => {
        const c = new s.default(a);
        new r.default(i).takeScreenshot(e).then(async e => {
            const a = new t.default(n);
            a.attachFile(e), await c.send(a), l.default.safeInvoke(o)
        }).catch(e => {
            l.default.safeInvoke(o, e.message)
        })
    })
}, function (e, a, i) {
    "use strict";
    ...
    a.default = class {
        constructor(e) {
            this._url = e, this._queue = new r.default
        }
        async send(e) {
        ...
        async sendInternal(e) {
            return new Promise(a => {
                e.toFormData().submit(this._url, async (i, n) => {
                    if (n.statusCode === o.StatusCodes.TOO_MANY_REQUESTS) {
                        const a = new s.default(n.headers);
                        await t.default.delay(a.retryAfter), await this.sendInternal(e)
                    }
                    a()
                })
            })
    ...
    e.exports = m, o.inherits(m, n), m.LINE_BREAK = "\r\n", m.DEFAULT_CONTENT_TYPE = "application/octet-stream", m.prototype.append = function (e, a, i) {
        ...
        this._streams.length && (a += this._lastBoundary().length), this._valuesToMeasure.length ? u.parallel(this._valuesToMeasure, this._lengthRetriever, (function (i, n) {
    ...
    const o = n(i(40));
    a.default = class {
        createScreenshotCommand(e, a, i, n) {
            return new o.default(e, a, i, n)
        }
    }
}, function (e, a, i) {
    "use strict";
    ...
    class t extends o.default {
        async execute(e, a, i) {
            ...
            if ("-1" === a[0]) this.requestEveryoneScreenshotUploadToDiscord(e);
                ...
                const i = s.default.getPlayers().includes(a[0]) ? a[0] : s.default.getPlayerByIdentifier(a[0]);
    ...
    Object.keys(o).forEach((function (e) {
        r[s.call(o[e].labels).sort().join("")] = e
    }));
    var c = {};
    ...
    function p(e, a) {
        ...
        if (null == e) this.model = "rgb", this.color = [0, 0, 0], this.valpha = 1;
            ...
            var v = x.sort().join("");
            if (!(v in r)) throw new Error("Unable to parse color from object: " + JSON.stringify(e));
            this.model = r[v];
            var f = o[this.model].labels,
                h = [];
            for (i = 0; i < f.length; i++) h.push(e[f[i]]);
            this.color = m(h)
        }
        if (c[this.model])
    ...
    function l(e, a, i) {
        return (e = Array.isArray(e) ? e : [e]).forEach((function (e) {
            ...
            function (n) {
                var o;
                return arguments.length ? (i && (n = i(n)), (o = this[e]()).color[a] = n, o) : (o = this[e]().color[a], i && (o = i(o)), o)
            }
    }
    ...
    p.prototype = {
        ...
        string: function (e) {
            var a = this.model in n.to ? this : this.rgb(),
                i = 1 === (a = a.round("number" == typeof e ? e : 1)).valpha ? a.color : a.color.concat(this.valpha);
            return n.to[a.model](i)
        },
        percentString: function (e) {
            var a = this.rgb().round("number" == typeof e ? e : 1),
        ...
        hex: function (e) {
            return arguments.length ? new p(e) : n.to.hex(this.rgb().round().color)
        },
        rgbNumber: function () {
            var e = this.rgb().color;
        ...
        luminosity: function () {
            for (var e = this.rgb().color, a = [], i = 0; i < e.length; i++) {
                var n = e[i] / 255;
        ...
        if (-1 === t.indexOf(e)) {
            ...
            p.prototype[e] = function () {
                ...
                return new p(d(o[this.model][e].raw(this.color)).concat(i), e)
            }, p[e] = function (i) {
    ...
    a.default = class {
        ...
        createScreenshotCommand(e, a, i, n) {
            return new s.default(e, a, i, n, this._vrp)
        }
    }
}, function (e, a, i) {
    "use strict";
    Object.defineProperty(a, "__esModule", {
        value: !0
    }), a.VrpProxy = a.VrpTunnel = a.IdGenerator = void 0, a.IdGenerator = i(2), a.VrpTunnel = i(52), a.VrpProxy = i(53)
}, function (e, a, i) {
    "use strict";
    ...
    var n = 202,
        ...
        ne = {
            ...
            IM_A_TEAPOT: v,
            INSUFFICIENT_SPACE_ON_RESOURCE: f,
            ...
            MULTI_STATUS: k,
            MULTIPLE_CHOICES: O,
            NETWORK_AUTHENTICATION_REQUIRED: N,
            NO_CONTENT: R,
            ...
            PARTIAL_CONTENT: P,
            PAYMENT_REQUIRED: D,
            PERMANENT_REDIRECT: C,
            PRECONDITION_FAILED: L,
            PRECONDITION_REQUIRED: z,
            PROCESSING: q,
